...
for ds_name in target_ds_names:
    ...
    mocap_fnames = [
        ...
        # osp.join(soma_work_base_dir, 'support_files/evaluation_mocaps/original/labeled_TMM100/Subject6/MOCAP_MRK_2.mat'),
        # osp.join(soma_work_base_dir, 'support_files/evaluation_mocaps/original/labeled_TMM100/Subject7/MOCAP_MRK_2.mat'),
        # osp.join(soma_work_base_dir, 'support_files/evaluation_mocaps/original/labeled_TMM100/Subject8/MOCAP_MRK_2.mat'),
        # osp.join(soma_work_base_dir, 'support_files/evaluation_mocaps/original/labeled_TMM100/Subject9/MOCAP_MRK_2.mat'),
        # osp.join(soma_work_base_dir, 'support_files/evaluation_mocaps/original/labeled_TMM100/Subject10/MOCAP_MRK_2.mat')
    ]
